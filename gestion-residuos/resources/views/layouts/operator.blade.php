...
<head>
    ...
    <style>
        ...
        .card { border-radius: 8px; border: 1px solid #dee2e6; }
    </style>
</head>
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navOperador">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('operador.dashboard') ? 'active' : '' }}" href="{{ route('operador.dashboard') }}">Dashboard</a>
                    </li>
                    @if(auth()->user()->id_punto_verde)
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('operador.entrega.create') ? 'active' : '' }}" href="{{ route('operador.entrega.create') }}">Registrar Entrega</a>
                    </li>
                    @endif
                </ul>
